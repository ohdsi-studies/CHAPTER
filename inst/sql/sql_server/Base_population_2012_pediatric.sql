...
WHERE C.observation_period_start_date <= DATEFROMPARTS(2012, 01, 01)
AND C.observation_period_end_date >= DATEFROMPARTS(2012, 01, 01)
AND YEAR(C.observation_period_start_date) - P.year_of_birth < 18
